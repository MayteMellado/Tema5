...
public class IMC {
	...
	public IMC(String nomPer, byte edadPer, char sexPer, float pesoPer, 
                float alturaPer) {
    ...
    public String toString() {
        return "IMC{" + "nomPer=" + nomPer + ", edadPer=" + edadPer 
                + ", sexPer=" + sexPer + ", pesoPer=" + pesoPer 
                + ", alturaPer=" + alturaPer + ", edoPesoPer=" + edoPesoPer 
                + ", imcPer=" + imcPer + '}';
    }
